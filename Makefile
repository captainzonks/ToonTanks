...
ToonTanks-Linux-Debug:
	 $(PROJECTBUILD) ToonTanks Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
ToonTanks-Linux-Test:
	 $(PROJECTBUILD) ToonTanks Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

ToonTanks:
	 $(PROJECTBUILD) ToonTanks Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

ToonTanksEditor-Linux-Debug:
	 $(PROJECTBUILD) ToonTanksEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)
...
ToonTanksEditor-Linux-Test:
	 $(PROJECTBUILD) ToonTanksEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)
