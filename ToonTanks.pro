...
unrealRootPath=/home/mbarham/UnrealEngine
ToonTanksRootPath=/home/mbarham/Documents/Unreal Projects/ToonTanks

gameProjectFile=/home/mbarham/Documents/Unreal Projects/ToonTanks/ToonTanks.uproject
...
include(ToonTanksSource.pri)
include(ToonTanksHeader.pri)
include(ToonTanksConfig.pri)
include(ToonTanksIncludes.pri)
include(ToonTanksDefines.pri)

ToonTanks-Linux-Debug.commands = $$build ToonTanks Linux Debug  -project="\"$$gameProjectFile\"" $$args
ToonTanks-Linux-DebugGame.commands = $$build ToonTanks Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ToonTanks-Linux-Shipping.commands = $$build ToonTanks Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ToonTanks-Linux-Test.commands = $$build ToonTanks Linux Test  -project="\"$$gameProjectFile\"" $$args
ToonTanks.commands = $$build ToonTanks Linux Development  -project="\"$$gameProjectFile\"" $$args

ToonTanksEditor-Linux-Debug.commands = $$build ToonTanksEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
ToonTanksEditor-Linux-DebugGame.commands = $$build ToonTanksEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
ToonTanksEditor-Linux-Shipping.commands = $$build ToonTanksEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
ToonTanksEditor-Linux-Test.commands = $$build ToonTanksEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
ToonTanksEditor.commands = $$build ToonTanksEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
